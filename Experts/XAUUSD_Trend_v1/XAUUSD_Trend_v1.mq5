...
input int    H4_Swing_Lookback  = 20;    // H4 bars to look back for swing high/low level
input double Swing_Touch_Buffer = 0.5;  // ATR multiplier: H1 bar must come within N*ATR of H4 swing level
...
//+------------------------------------------------------------------+
//| Get most recent H4 swing low (pivot low)                        |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Get most recent H4 swing high (pivot high)                      |
//+------------------------------------------------------------------+
...
int GetH1Signal(int trend, double &out_swing_level)
  {
   ...
   double touch_range = Swing_Touch_Buffer * atr_val;
